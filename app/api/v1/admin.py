...
async def worker_get_settings():
    ...
    grok_cfg = {
        ...
        "retry_backoff_base": get_config("grok.retry_backoff_base", 1),
        "retry_backoff_factor": get_config("grok.retry_backoff_factor", 2),
        "retry_backoff_max": get_config("grok.retry_backoff_max", 30),
...
async def worker_save_settings(data: dict):
    ...
    update_cfg = {
        ...
        "grok": {
            ...
            "retry_backoff_base": grok_cfg.get("retry_backoff_base"),
            "retry_backoff_factor": grok_cfg.get("retry_backoff_factor"),
            "retry_backoff_max": grok_cfg.get("retry_backoff_max"),
